    ...
    <form action="/student" method="POST">
        <div class="row g-1 align-items-center">
            <div class="col-4">
                ...
                <input class="form-control" name="nome" type="text" placeholder="nome" aria-label="Busca" value="<?= $old['nome'] ?? '' ?>">
            </div>
            <div class="col-4">
                <label for="cpf">CPF</label>
                <input class="form-control" name="cpf" type="text" placeholder="Busca" aria-label="Busca" value="<?= $old['cpf'] ?? '' ?>">
            </div>
            <div class="col-4">
